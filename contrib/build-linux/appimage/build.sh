...
(
    ...
    cd "$APPDIR"
    #cp -rf $BUILDDIR/python-trezor/trezorlib $APPDIR/usr/lib/python3.6/site-packages/
...
(
    ...
    #info "copied to Trezorlib Start ."
    #cp -rf $BUILDDIR/python-trezor/trezorlib $APPDIR/usr/lib/python3.6/site-packages/
    #info "copied to Trezorlib End."
